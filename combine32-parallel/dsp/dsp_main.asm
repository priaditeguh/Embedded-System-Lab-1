...
;	/data/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/27762TnVX7B /tmp/277621mKN3v 
	.sect	".text"
	.clink
	.global	_main
...
$C$DW$16	.dwtag  DW_TAG_subprogram, DW_AT_name("main")
	...
	.dwattr $C$DW$16, DW_AT_TI_begin_line(0x131)
	.dwattr $C$DW$16, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$16, DW_AT_frame_base[DW_OP_breg31 16]
	.dwattr $C$DW$16, DW_AT_TI_skeletal
	.dwpsn	file "dsp_main.c",line 306,column 1,is_stmt,address _main
...
;          EXCLUSIVE CPU CYCLES: 9
           MVKL    .S1     _DSPLINK_init,A3  ; |309| 
           MVKH    .S1     _DSPLINK_init,A3  ; |309| 
           STW     .D2T2   B11,*SP--(16)     ; |306| 
$C$DW$19	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$19, DW_AT_TI_call
           CALL    .S2X    A3                ; |309| 
           MV      .L2     B3,B11            ; |306| 
           STW     .D2T2   B10,*+SP(12)      ; |306| 
           MV      .L2     B4,B10            ; |306| 
           ADDKPC  .S2     $C$RL0,B3,1       ; |309| 
$C$RL0:    ; CALL OCCURS {_DSPLINK_init} {0}  ; |309| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 18
           MVKL    .S1     _atoi,A3          ; |312| 
           MVKH    .S1     _atoi,A3          ; |312| 
           LDW     .D2T1   *B10,A4           ; |312| 
$C$DW$20	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$20, DW_AT_TI_call
           CALL    .S2X    A3                ; |312| 
           ADDKPC  .S2     $C$RL1,B3,4       ; |312| 
$C$RL1:    ; CALL OCCURS {_atoi} {0}         ; |312| 

           ZERO    .L2     B4                ; |315| 
||         MVK     .S1     127,A3            ; |312| 

           STW     .D2T2   B4,*+SP(8)        ; |315| 
||         MVKL    .S2     _TSK_create,B4    ; |315| 
||         ADD     .L1     A3,A4,A3          ; |312| 

           MVKH    .S2     _TSK_create,B4    ; |315| 
||         SHR     .S1     A3,6,A4           ; |312| 
...
||         MVKL    .S1     _Task,A4          ; |315| 
||         MVKH    .S2     _MPCSXFER_BufferSize,B5

           STH     .D2T1   A3,*B5            ; |312| 
||         MVKH    .S1     _Task,A4          ; |315| 
||         ADDKPC  .S2     $C$RL2,B3,0       ; |315| 

$C$RL2:    ; CALL OCCURS {_TSK_create} {0}   ; |315| 
;** --------------------------------------------------------------------------*
...
$C$DW$22	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$22, DW_AT_TI_return
           ...
           RET     .S2     B3                ; |316| 
||         LDW     .D2T2   *+SP(12),B10      ; |316| 

           LDW     .D2T2   *++SP(16),B11     ; |316| 
	.dwpsn	file "dsp_main.c",line 316,column 1,is_stmt
           NOP             4
           ; BRANCH OCCURS {B3}              ; |316| 
	.dwattr $C$DW$16, DW_AT_TI_end_file("dsp_main.c")
	.dwattr $C$DW$16, DW_AT_TI_end_line(0x13c)
...
;          EXCLUSIVE CPU CYCLES: 8
           MVKL    .S2     _Task_create,B4   ; |333| 
           MVKH    .S2     _Task_create,B4   ; |333| 
$C$DW$24	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$24, DW_AT_low_pc(0x00)
	.dwattr $C$DW$24, DW_AT_name("_Task_create")
	.dwattr $C$DW$24, DW_AT_TI_call
           CALL    .S2     B4                ; |333| 
           STW     .D2T2   B3,*SP--(8)       ; |328| 
           ADDKPC  .S2     $C$RL3,B3,2       ; |333| 
           ADD     .L1X    4,SP,A4           ; |333| 
$C$RL3:    ; CALL OCCURS {_Task_create} {0}  ; |333| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 8

           MV      .L1     A4,A0             ; |333| 
||         MVKL    .S1     _Task_execute,A3  ; |338| 
||         LDW     .D2T1   *+SP(4),A4        ; |338| 

   [ A0]   MVKL    .S2     _Task_delete,B4   ; |346| 
||         MVKH    .S1     _Task_execute,A3  ; |338| 
|| [ A0]   LDW     .D2T1   *+SP(4),A4        ; |346| 

   [ A0]   MVKH    .S2     _Task_delete,B4   ; |346| 
|| [ A0]   B       .S1     $C$L1             ; |333| 
...
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 9
           ADDKPC  .S2     $C$RL4,B3,1       ; |338| 
$C$RL4:    ; CALL OCCURS {_Task_execute} {0}  ; |338| 
           MVKL    .S2     _Task_delete,B4   ; |346| 
           MVKH    .S2     _Task_delete,B4   ; |346| 
$C$DW$27	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$27, DW_AT_low_pc(0x00)
	.dwattr $C$DW$27, DW_AT_name("_Task_delete")
	.dwattr $C$DW$27, DW_AT_TI_call
           CALL    .S2     B4                ; |346| 
           LDW     .D2T1   *+SP(4),A4        ; |346| 
           NOP             3
;** --------------------------------------------------------------------------*
$C$L1:    
;          EXCLUSIVE CPU CYCLES: 1
           ADDKPC  .S2     $C$RL5,B3,0       ; |346| 
$C$RL5:    ; CALL OCCURS {_Task_delete} {0}  ; |346| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 11
           LDW     .D2T2   *++SP(8),B3       ; |353| 
           NOP             4
	.dwpsn	file "dsp_main.c",line 353,column 1,is_stmt
$C$DW$28	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$23, DW_AT_TI_end_line(0x161)
